...
public class update_customer {
    public update_customer(String text) {
        final JFrame frame = new JFrame();
        frame.setBounds(600,200,700,700);
        frame.setTitle("update_customer");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.update_Customer(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
