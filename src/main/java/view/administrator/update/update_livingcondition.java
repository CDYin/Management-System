...
public class update_livingcondition {
    public update_livingcondition(String text, String text1) {
        final JFrame frame = new JFrame();
        frame.setBounds(600,200,700,700);
        frame.setTitle("update_livingcondition");
        ...
        final JTextField jtf2 = new JTextField(text1);
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.update_LIvingCondition(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
