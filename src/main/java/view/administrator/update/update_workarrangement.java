...
public class update_workarrangement {
    public update_workarrangement(String text) {
        final JFrame frame = new JFrame();
        frame.setBounds(600,200,700,700);
        frame.setTitle("update_workarrangement");
        frame.setLayout(null);
        frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);

        JLabel j1 = new JLabel("工作编号");
        JLabel j2 = new JLabel("员工编号");
        JLabel j3 = new JLabel("每日工作安排");
        JLabel j4 = new JLabel("是否完成");
        JLabel j5 = new JLabel("备注");
        JLabel j6 = new JLabel("发布人员编号");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.update_WorkArrangement(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
