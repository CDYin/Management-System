...
public class update_hotelgood {
    public update_hotelgood(String text) {
        final JFrame frame = new JFrame();
        frame.setBounds(600,200,700,700);
        frame.setTitle("update_hotelgood");
        frame.setLayout(null);
        frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);

        JLabel j1 = new JLabel("物品编号");
        JLabel j2 = new JLabel("名称");
        JLabel j3 = new JLabel("位置");
        JLabel j4 = new JLabel("数量");
        JLabel j5 = new JLabel("存放位置");
        JLabel j6 = new JLabel("备注");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.update_HotelGoods(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
