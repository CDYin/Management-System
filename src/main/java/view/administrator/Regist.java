...
public class Regist {
    Regist(){
        ...
        frame.setTitle("Administrtor-Regist");
        ...
        JLabel j10 = new JLabel("更新时间");
        JLabel j11 = new JLabel("更新人编号");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.add_Administrators(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
