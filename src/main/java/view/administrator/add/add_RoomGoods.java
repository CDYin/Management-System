...
public class add_RoomGoods {
    add_RoomGoods(){
        final JFrame frame = new JFrame();
        frame.setBounds(600,200,700,700);
        frame.setTitle("add_RoomGoods");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.add_HotelGoods(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
