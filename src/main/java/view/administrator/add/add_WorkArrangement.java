...
public class add_WorkArrangement {
    add_WorkArrangement(){
        final JFrame frame = new JFrame();
        frame.setBounds(600,200,700,700);
        frame.setTitle("add_WorkArrangement");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                administratorsController.add_WorkArrangement(jtf1.getText(),jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
